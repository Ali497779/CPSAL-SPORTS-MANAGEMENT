        ...
        <div class="card-body">
            <form action="{{ route('coach.school.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="fax" id="fax" class="form-control" placeholder="Enter fax number">
                    @error('fax')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" name="principal_name" id="principal_name" class="form-control" placeholder="Enter principal name ">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="principal_phone" id="principal_phone" class="form-control" placeholder="Enter principal phone ">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" name="principal_email" id="principal_email" class="form-control" placeholder="Enter principal email ">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="director_phone" id="director_phone" class="form-control" placeholder="Enter director phone ">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" name="director_email" id="director_email" class="form-control" placeholder="Enter director email ">
                    @error('director_email')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                <div class="d-flex justify-content-center">
                    <a href="{{ route('coach.school.index') }}" class="btn btn-danger text-white mr-3"><i class="fa fa-times"></i> Cancel</a>
