<x-layouts.dashboard title="Team Create">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('coach.teams.players.store', request()->teamId) }}" method="post">
                @csrf
                ...
                <div class="d-flex justify-content-center">
                    <a href="{{ route('coach.teams.index') }}" class="btn btn-danger text-white mr-3"><i class="fa fa-times"></i>
                        Cancel</a>
