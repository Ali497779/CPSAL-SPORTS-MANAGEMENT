    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('admin.banner.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <h3>Banner Upload</h3>
                    <input type="file" name="image" id="image-upload" accept="image/*" onchange="displayImage(event)" />
                ...
                <div class="mb-3">
                    <label for="name" class="form-label">Heading <sup class="text-danger">*</sup></label>
                    <input type="text" name="heading" id="heading" value="{{ old('heading') }}" class="form-control" placeholder="Enter White Heading">
                    @error('heading')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                <div class="mb-3">
                    <label for="name" class="form-label">Quote <sup class="text-danger">*</sup></label>
                    <input type="text" name="quote" id="quote" value="{{ old('quote') }}" class="form-control" placeholder="Enter name">
                    @error('quote')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
